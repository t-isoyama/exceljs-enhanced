  ...
  async load(data, options) {
    ...
    for (const [filename, fileData] of Object.entries(files)) {
      ...
      if (
        ...
        // Binary data (images, themes) - use Readable.from for immediate availability
        stream = Readable.from([Buffer.from(fileData)]);
      } else {
        // Text data (XML) - create chunks and use object mode
        ...
        stream = Readable.from(chunks, {objectMode: true});
      }
