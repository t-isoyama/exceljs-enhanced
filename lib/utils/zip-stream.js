...
class ZipWriter extends EventEmitter {
  ...
  _appendStream(stream, options) {
    ...
    // Use PassThrough to collect stream data via piping
    // StreamBuf and other custom streams work better with piping than events
    ...
    // Pipe the source stream through PassThrough
    try {
