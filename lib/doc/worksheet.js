...
class Worksheet {
  ...
  protect(password, options) {
    // Note: Encryption is synchronous (fast for most use cases)
    // Future: Could use Worker Thread for very large spinCount values
...
Please leave feedback at https://github.com/exceljs/exceljs/discussions/2575`
  ...
  get tabColor() {
    // eslint-disable-next-line no-console
    console.warn('worksheet.tabColor property is now deprecated. Please use worksheet.properties.tabColor');
